import argparse
from sandbox.simulator_attack import Simulator
...
if __name__ == "__main__":
    ...
    # parser.add_argument("--auto_number", default=False, action='store_true', help="Whether given number of agents")
    ...
    parser.add_argument("--end_id", type=int, default=51, help="index of end instance")
    ...
    for i in tqdm(selected_ids[idx:108], desc="Running Instances", position=0, leave=True):
        print(f"\n=== Running instance {i} ===")
